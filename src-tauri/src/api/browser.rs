//! Browser control HTTP handlers: all /api/browser/:id/* routes.
//! Also contains action log HTTP endpoints and cookie export/import helpers.

use super::{cdp_err, require_cdp_port, ApiResult, ApiState};
use crate::api::action_log;
use axum::{
